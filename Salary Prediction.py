...
# We want to be able to create salary predictions of certain jobs based on the dataset provided that contains info about job titles, distance from city, years of experience and other attributes.
...
# Therefore, these outliers are acceptable.
...
# Function that creates plots to explore the feature variables
